                    ...
                    <form action="booking" method="POST">
                        ...
                        <select class="form-control" name="tos" id="tos" style="width: 50%;height: 5%;">
                                               ...
                                               <input type="date" name="tdate" style="width: 50%;"> <br><br>
                                                 <font size="4" face="Baskerville Old Face" style="width: 180%;"><b>No Adult's</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <select class="form-control" name="adult" id="adult" style="width: 50%;height: 5%;">
                                                ...
                                                <font size="4" face="Baskerville Old Face" style="width: 180%;"><b>No Child's</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <select class="form-control" name="child" id="child" style="width: 50%;height: 5%;">
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                                <option value="3">3</option>
                                                <option value="4">4</option>
                        ...
                        <button style="width:90%;" onclick=" return loginValidation()"> BOOK TICKET</button>
                    </form>
                    </div>
